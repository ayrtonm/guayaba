        ...
        macro_rules! compute {
            ...
            (rd = rs $method:ident rt) => {{
                ...
                log!(
                    ...
                    stringify!($method),
                    rt,
                    self.console.r3000.nth_reg(get_rd(op))
                );
                None
            }};
                ...
                match result {
                    ...
                    None => {
                        ...
                        *pc = self
                            .console
                            .cop0
                            .generate_exception(Cop0Exception::Overflow, *pc);
                    },
                }
                log!(
                    "R{} = R{} {} R{} trap overflow\n  = {:#x} {} {:#x}\n  = {:#x}",
            ...
            (rt = rs $method:ident signed imm16 trap) => {{
                ...
                log!(
                    ...
                    stringify!($method),
                    imm16,
                    self.console.r3000.nth_reg(get_rt(op))
                );
                None
            }};
            ...
            ($copn:ident) => {{
                match get_rs(op) {
                    0x00 => {
                        ...
                        self.console
                            .delayed_writes
                            .push_back(DelayedWrite::new(Name::Rn(rt), rd_data));
                        log!(
                            "R{} = {}R{}\n  = {:#x} after the delay slot",
                            rt,
                            stringify!($copn),
                    ...
                    0x02 => {
                        ...
                        self.console
                            .delayed_writes
                            .push_back(DelayedWrite::new(Name::Rn(rt), rd_ctrl));
                        None
                    },
                    0x04 => {
                        //MTCn
                ...
                match get_secondary_field(op) {
                    ...
                    0x0C => {
                        ...
                        *pc = self
                            .console
                            .cop0
                            .generate_exception(Cop0Exception::Syscall, *pc);
                        None
                    },
                    0x0D => {
                        //BREAK
